...
return function(props: LabelProperties): TextLabel
	...
	local newLabel = New "TextLabel" {
		...
		TextWrapped = true,
		TextTruncate = props.NoScaling and Enum.TextTruncate.SplitWord or Enum.TextTruncate.None,

		AutomaticSize = props.NoScaling and Enum.AutomaticSize.None or Enum.AutomaticSize.Y,

		Size = props.NoScaling and Computed(function()
			return UDim2.new(1, 0, 0, unwrap(textSize))
		end) or UDim2.new(1, 0, 0, 0),
