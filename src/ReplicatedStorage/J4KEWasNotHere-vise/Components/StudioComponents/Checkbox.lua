...
return function(props: CheckboxProperties): Frame
	...
	local checkFieldIndicatorColor =
		themeProvider:GetColor(Enum.StudioStyleGuideColor.CheckedFieldIndicator, mainModifier)
					...
					[Children] = New("ImageLabel")({
						...
						ImageColor3 = getMotionState(
							Computed(function()
								...
								return if unwrap(isIndeterminate)
						...
						ImageRectOffset = Computed(function()
							if unwrap(isIndeterminate) then
								return if unwrap(themeProvider.IsDark)
									then Vector2.new(13, 0)
									else Vector2.new(26, 0)
							end
				...
				if props.Text then
					return New("TextLabel")({
						...
						TextXAlignment = Computed(function()
							return if unwrap(textHorizontalScale) == 1
